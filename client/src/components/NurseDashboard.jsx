...
const NurseDashboard = () => {
  ...
  if (loading) {
    return <div className="text-center p-8 text-slate-500 dark:text-slate-400 animate-pulse">Loading patient queue...</div>;
  }
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Manage patient vitals and doctor queue</p>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="glass-panel py-2 px-4 flex items-center gap-3 bg-white/80 dark:bg-slate-800/80">
            ...
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400">Vitals Recorded</div>
        ...
        {patients.map(p => (
          ...
          >
            ...
            <div>
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400">{p.age} years • {p.gender}</p>
                </div>
              ...
              <div className="mb-3 p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex justify-between items-center text-xs">
                ...
                <span className="text-[10px] text-slate-500 dark:text-slate-400">O2 Flow: 2L/min</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="bg-slate-50/50 dark:bg-slate-900/50 p-3 rounded-lg flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-slate-500 dark:text-slate-400">SpO2</div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              ...
              <button className="py-2 bg-slate-700 hover:bg-emerald-600 text-slate-900 dark:text-white rounded-lg text-xs font-semibold transition-colors">
                ✏️ Update Vitals
              </button>
            </div>
          </motion.div>
