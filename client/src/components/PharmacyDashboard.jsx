    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Review prescriptions and manage inventory</p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="glass-panel p-5 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 border border-indigo-500/30 rounded-xl space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 bg-slate-50/80 dark:bg-slate-900/80 rounded-lg border border-slate-200 dark:border-slate-800 flex justify-between items-center">
                <div>
              ...
              <div className="p-2 bg-slate-50/80 dark:bg-slate-900/80 rounded-lg border border-slate-200 dark:border-slate-800 flex justify-between items-center">
                <div>
                  <span className="text-slate-900 dark:text-white font-bold block">Brand: Pantocid 40</span>
          ...
          <div className="glass-panel p-5 bg-white/60 dark:bg-slate-800/60 border border-slate-300/50 dark:border-slate-700/50 rounded-xl">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-slate-50/50 dark:bg-slate-900/50 rounded-lg border border-red-500/20">
                <div>
                  <div className="text-sm font-medium text-slate-900 dark:text-white">Amoxicillin 250mg</div>
                  <div className="text-xs text-red-400">Critical: 15 strips • Exp: 09/2026</div>
                </div>
                <button className="text-xs bg-slate-700 hover:bg-slate-600 text-slate-900 dark:text-white px-2.5 py-1 rounded transition-colors font-bold">Reorder</button>
              </div>
              <div className="flex justify-between items-center p-3 bg-slate-50/50 dark:bg-slate-900/50 rounded-lg border border-amber-500/20">
                <div>
                  <div className="text-sm font-medium text-slate-900 dark:text-white">Electral ORS Sachets</div>
