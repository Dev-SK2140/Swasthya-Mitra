    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Register new patients and manage appointments</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="glass-panel bg-slate-800/40 p-0 overflow-hidden border border-slate-300/50 dark:border-slate-700/50 rounded-2xl">
            <div className="p-4 border-b border-slate-300/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-900/50 flex items-center gap-2">
              ...
              <h3 className="font-medium text-slate-900 dark:text-white">New Patient Registration</h3>
            </div>
            <div className="p-6">
          ...
          <div className="glass-panel p-5 bg-white/60 dark:bg-slate-800/60 border border-slate-300/50 dark:border-slate-700/50 rounded-xl space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-lg text-center border border-slate-200 dark:border-slate-800">
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Tokens Issued</div>
              </div>
              <div className="bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-lg text-center border border-slate-200 dark:border-slate-800">
                <div className="text-3xl font-bold text-[var(--color-secondary)]">12</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Waiting OPD</div>
              </div>
            </div>
            <button className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 text-slate-900 dark:text-white rounded-xl text-xs font-bold transition-all shadow-lg flex items-center justify-center gap-1.5">
          ...
          <div className="glass-panel p-5 bg-white/60 dark:bg-slate-800/60 border border-slate-300/50 dark:border-slate-700/50 rounded-xl">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center py-2 border-b border-slate-300/50 dark:border-slate-700/50">
                <span className="text-slate-600 dark:text-slate-300">108 EMRI Ambulance</span>
                <span className="text-slate-900 dark:text-white font-mono bg-slate-50 dark:bg-slate-900 px-2 py-1 rounded">108</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-slate-300/50 dark:border-slate-700/50">
                <span className="text-slate-600 dark:text-slate-300">District Blood Bank</span>
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-slate-600 dark:text-slate-300">Duty Doctor On-Call</span>
