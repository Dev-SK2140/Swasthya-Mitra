        ...
        >
          ...
          <div className="flex justify-between items-center p-5 border-b border-slate-800 bg-slate-900/60">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">108 EMRI Live Ambulance Dispatch</h3>
                <p className="text-xs text-slate-400">Emergency Medical Response Institute (Gujarat Govt.)</p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 relative overflow-hidden text-left space-y-3">
              ...
              <div className="p-3 bg-slate-900/80 rounded-xl border border-slate-800 text-xs text-slate-300 flex items-center justify-between">
                <div>
                  <span className="font-semibold text-white block">ICU Equipment Onboard:</span>
                  <span className="text-[10px] text-slate-400 block">Defibrillator, Oxygen Cylinder, Ventilator, Syringe Pump</span>
                </div>
              </div>
            </div>
