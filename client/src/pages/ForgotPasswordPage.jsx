        ...
        <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl py-8 px-4 shadow-[0_8px_30px_rgb(0,0,0,0.5)] sm:rounded-2xl sm:px-10 border border-slate-200 dark:border-white/10">
          ...
          {step === 1 ? (
            <form className="space-y-6" onSubmit={handleSendOtp}>
              <p className="text-slate-500 dark:text-slate-400 text-sm text-center">Enter your email to receive an OTP.</p>
              <div>
            ...
            <form className="space-y-6" onSubmit={handleReset}>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input required type={showPassword ? "text" : "password"} value={newPassword} onChange={e => setNewPassword(e.target.value)} className="block w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-50/50 dark:bg-slate-900/50 text-slate-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] pr-12" />
